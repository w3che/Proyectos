                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td scope="row"><a class="btn btn-warning btn-sm" href="./view/update_form.php?id=<?php echo $fila['id_nivel'];?>"><i class="bi bi-pencil-square"></i></a></td>
                                            <td scope="row"><a class="btn btn-danger btn-sm" href="./functions/delete.php?id=<?php echo $fila['id_nivel'];?>"><i class="bi bi-x-square"></i></a></td>
                                        </tr>
                                        <?php $contador++;} ?>
                                    </tbody>
                                </table>
